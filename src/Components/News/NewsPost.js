                ...
                <div className="col-md-8 news-post">
                   ...
                   <div className="news-title">
                    ...
                    <div className="news-body mt-4">
                        <img className="news-image" style={{backgroundImage:`url(./img/1.jpg)`}}></img>
                    </div>
                   ...
                   <div className="news-title">
                    ...
                    <div className="news-body mt-4">
                        <img className="news-image" style={{backgroundImage:`url(./img/2.jpg)`}}></img>
                    </div>
                    <div className="news-tag d-flex align-items-center my-4">
                        <h3 className="my-0 me-3">TAGS: </h3>
                        <span>Dishes</span>
                   ...
                   <div className="news-title">
                    ...
                    <div className="news-body mt-4">
                        <img className="news-image" style={{backgroundImage:`url(./img/3.jpg)`}}></img>
                    </div>
                    <div className="news-tag d-flex align-items-center my-4">
                        <h3 className="my-0 me-3">TAGS: </h3>
                        <span>12 march 2021</span>
